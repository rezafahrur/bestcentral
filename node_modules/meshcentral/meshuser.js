            ...
            case 'meshmessenger':
                {
                    ...
                    if (common.validateString(command.userid, 1, 2048)) {
                        ...
                        // Create the notification message
                        var notification = {
                            "action": "msg", "type": "notify", "value": "Chat Request, Click here to accept.", "title": user.name, "userid": user._id, "username": user.name, "tag": 'BeStCentral messenger/' + encodeURIComponent(command.userid) + '/' + encodeURIComponent(user._id)
                        };
